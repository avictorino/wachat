...
- Se fizer uma pergunta, escolha UMA pergunta simples sobre padrões, necessidades ou próximos passos.
...
- Se fizer uma pergunta, escolha UMA pergunta aberta e simples.

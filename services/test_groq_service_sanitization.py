...
class GroqServiceSanitizationTest(TestCase):
    ...
    def test_infer_gender_sanitizes_input(self, mock_sanitize, mock_groq_client):
        ...
        service = GroqService()
        result = service.infer_gender("Sexo Silva")
    ...
    @patch("services.groq_service.Groq")
    @patch("services.groq_service.sanitize_input")
    def test_generate_welcome_message_sanitizes_input(self, mock_sanitize, mock_groq_client):
        ...
        # Create service and call method
        service = GroqService()
        result = service.generate_welcome_message("Morte Santos", inferred_gender="male")

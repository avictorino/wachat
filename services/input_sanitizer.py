...
class InputSanitizer:
    ...
    def __init__(self):
        ...
        self.sexual_keywords = self._compile_patterns(
            [
                ...
                r"\bestupro\b",
                r"\bestupr[oa]d[oa]\b",
                r"\babuso\b.*\bsexual\b",
                r"\bsexual\b.*\babuso\b",
                r"\bincesto\b",
                r"\bpedofilia\b",
                r"\bnudes?\b",
                r"\bnua?\b",
                ...
                r"\bintim[oa]s?\b",
                r"\bíntim[oa]s?\b",
                r"\brelação\b.*\bsexual\b",
                r"\bsexual\b.*\brelação\b",
            ]
        )
        ...
        self.controversial_keywords = self._compile_patterns(
            [
                r"\baborto\b",
                r"\binterrupção\b.*\bgravidez\b",
                r"\babortar\b",
                r"\babortivo\b",
                r"\beutanásia\b",
                r"\bsuicídio\b.*\bassistido\b",
                r"\bgenocídio\b",
                r"\bextermínio\b",
                r"\bditadura\b",
                r"\bditador\b",
                ...
                r"\bextremista\b",
                r"\bradicalismo\b",
                r"\bradical\b.*\breligios[oa]\b",
                r"\bguerra\b.*\breligios[oa]\b",
                r"\breligios[oa]\b.*\bguerra\b",
                r"\bodio\b",
                r"\bpreconceito\b",
                r"\bdiscriminação\b",
                r"\bracismo\b",
                ...
                r"\bhomofobia\b",
                r"\btransfobia\b",
                r"\bviolência\b.*\bpolític[oa]\b",
                r"\bpolític[oa]\b.*\bviolência\b",
            ]
        )
    ...
    def _detect_harmful_content(self, text: str) -> Dict[str, List[str]]:
        ...
        """
        detections = {"sexual": [], "death": [], "controversial": []}
    ...
    def sanitize(self, text: str, log_detections: bool = True) -> str:
        ...
        try:
            ...
            all_patterns = (
                self.sexual_keywords + self.death_keywords + self.controversial_keywords
            )
            ...
            logger.error(f"Error during input sanitization: {str(e)}", exc_info=True)
